...
CONTENT.PHASE2.TICKETS <- c('CURRENCY', 'LEVERAGE', 'TICKETS.RAW', 'ITEM.SYMBOL.MAPPING', 'SUPPORTED.ITEM',
                            'UNSUPPORTED.ITEM', 'TICKETS.SUPPORTED', 'TICKETS.EDITING')
CONTENT.PHASE3.ANALYSIS <- c('TICKETS.EDITED', 'PERIOD', 'PRICE', 'TIMESERIE.TICKETS', 'TIMESERIE.SYMBOLS', 'TIMESERIE.ACCOUNT')
