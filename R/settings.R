...
#### REPORT CONTENT ####
CONTENT.PHASE1.INIT <- c('INFOS', 'HTML.PARSE', 'PATH')
CONTENT.PHASE2.TICKETS <- c('CURRENCY', 'LEVERAGE', 'TICKETS.RAW', 'ITEM.SYMBOL.MAPPING', 'SUPPORTED.ITEM', 'UNSUPPORTED.ITEM', 'TICKETS.SUPPORTED')
